...
echo "======================================"
echo "Building Yield Downloader Container"
echo "======================================"
...
then
    ...
    echo "   gcloud run jobs create yield-downloader \\"
    echo "     --image ${FULL_IMAGE_NAME} \\"
    echo "     --region ${REGION} \\"
    echo "     --service-account yield-downloader@${PROJECT_ID}.iam.gserviceaccount.com"
fi
